...
for page_number in range(len(pdf_document)):
    ...
    output_file_path = 'output_results2.xlsx'
...
'''   
try:
    po_existing = pd.read_excel(file_path, engine='openpyxl')
...
po_combined.to_excel(file_path, index=False, engine='openpyxl')
...
print(f"Results saved to {file_path}")
    ...
    #pos_weight_qty.append((match_po,match_weight,match_qty_pieces))
